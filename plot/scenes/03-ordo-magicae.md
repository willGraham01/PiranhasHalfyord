...
- Faire was not present in the building when she returned. Groubun was upstairs in his study, working on a research paper related to their experiment earlier in the day. Groubun claimed that Faire had left around 13:00 to attend a meeting with the city officials. Shufharz and Kamonas will say he never showed up, which is out of character for the Ordinator.
...
She will also request that the party does not wander off when they move to the second floor, as the 2nd and 3rd floors are technically off limits to the public - this is mainly a request to plant the idea in the player's heads that there is other information to be found.
...
- If Groubun is confronted with the above assessment, he will smirk slightly (as if in appreciation for knowledge) and confirm the character's investigation. He'll go on to say that these salves instead work by physically stitching and morphing the body to repair itself, rather than the "usual" healing method of revitalising the body.
  - (Arcana, DC 20) This explanation seems plausible, but typically magical essences do not care about _how_ an effect takes place, only the nature of the effect.
...
## Arriving after visiting the docks
...
- (Insight DC 5) Something about the manner in which Groubun says he's going to the temple doesn't sit quite right (it's very late, why not make the delivery in the day when it's likely needed more, for example).
